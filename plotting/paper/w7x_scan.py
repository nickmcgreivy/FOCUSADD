...
coil_data_7, params_7 = get_all_coil_data("../../tests/w7x/scan2/w7x_l7.hdf5") # 0.0525
...
norm_1 = np.mean(np.abs(np.reshape(centroid_fil - centroid_1,-1))) ### THESE ARE ALL WRONG BECAUSE I DIDNT TAKE THE NORM
