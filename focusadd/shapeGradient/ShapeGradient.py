...
class ShapeGradient:
	...
	def coil_gradient(self,f_phys=True,f_eng=True):
		...
		loss, shape_grad = grad_loss(self.coil_set.get_r(),f_phys=f_phys,f_eng=f_eng)
	...
	def coil_hessian(self,f_phys=True, f_eng=True):
		...
		print(self.coil_set.get_r().shape)
		H = hessian_func(self.coil_set.get_r(),f_phys=f_phys,f_eng=f_eng)
		print(H.shape)
